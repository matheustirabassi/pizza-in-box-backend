...
public class CursomcApplication implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    //
    // Produto p1 = new Produto(null, "Bis", 4.59, null);
    // Produto p2 = new Produto(null, "Diamante negro", 4.59, null);
    // Produto p3 = new Produto(null, "Pc Gamer", 6.900, null);
    // Produto p4 = new Produto(null, "Mesa de madeira", 400.00, null);
    //
    ...
    //
    // Cliente cli1 = new Cliente(null, "Matheus", "tirabassi.matheus@aluno.ifsp.edu.br",
    // "38384032810",
    ...
    //
    // Endereco e1 = new Endereco(null, "R Flores", "300", "Apto 300", "Jardina", "18520000", c1,
    // cli1);
    // Endereco e2 = new Endereco(null, "Avenida Presidente Kenedy", "105", "Sala 800", "Centro",
    // "14529-421", c2,
    // cli1);
    //
